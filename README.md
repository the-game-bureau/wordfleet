...
- Wheel of Fortune letter fill: whatever letter a captain calls in an Alpha Strike is filled in on every square of the opponent's fleet where it appears. This works for both captains.
